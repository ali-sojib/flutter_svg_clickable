...
class DistrictSelection {
  ...
  DistrictSelection(List<District> selectedDistricts) : selectedDistricts = UnmodifiableListView(selectedDistricts);
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is DistrictSelection && runtimeType == other.runtimeType &&
